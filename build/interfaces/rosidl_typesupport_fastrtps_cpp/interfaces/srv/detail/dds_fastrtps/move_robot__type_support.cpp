...
#include "interfaces/srv/detail/move_robot__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::srv::MoveRobot_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::MoveRobot_Request & ros_message)
{
  // Member: distance
  cdr >> ros_message.distance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::srv::MoveRobot_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::MoveRobot_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::srv::MoveRobot_Request *>(
    untyped_ros_message);
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, MoveRobot_Request)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::MoveRobot_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pose
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::MoveRobot_Response & ros_message)
{
  // Member: pose
  cdr >> ros_message.pose;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::MoveRobot_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::MoveRobot_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::MoveRobot_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, MoveRobot_Response)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Response__handle;
}
...
// functions for interfaces::srv::MoveRobot_Request already declared above

// functions for interfaces::srv::MoveRobot_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::MoveRobot_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::MoveRobot_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_MoveRobot_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_MoveRobot_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::MoveRobot_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_MoveRobot_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_MoveRobot_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const interfaces::srv::MoveRobot_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::MoveRobot_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, MoveRobot_Event)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot_Event__handle;
}
...
static const rosidl_service_type_support_t _MoveRobot__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<interfaces::srv::MoveRobot_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<interfaces::srv::MoveRobot_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<interfaces::srv::MoveRobot_Event>(),
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, MoveRobot)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_MoveRobot__handle;
}
