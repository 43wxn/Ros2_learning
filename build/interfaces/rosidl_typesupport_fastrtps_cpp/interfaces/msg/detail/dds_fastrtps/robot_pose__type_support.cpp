...
#include "interfaces/msg/detail/robot_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::RobotPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::RobotPose & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::RobotPose;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_key_RobotPose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const interfaces::msg::RobotPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::RobotPose *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, RobotPose)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
