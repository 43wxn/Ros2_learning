...
#include "interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::RobotStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, RobotStatus)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
