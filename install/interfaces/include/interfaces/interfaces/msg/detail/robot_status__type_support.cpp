...
{
  new (message_memory) interfaces::msg::RobotStatus(_init);
}

void RobotStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::RobotStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotStatus_message_member_array[2] = {
  {
    ...
    offsetof(interfaces::msg::RobotStatus, status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::RobotStatus, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces::msg::RobotStatus),
...
get_message_type_support_handle<interfaces::msg::RobotStatus>()
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::RobotStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, RobotStatus)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::RobotStatus_message_type_support_handle;
}
