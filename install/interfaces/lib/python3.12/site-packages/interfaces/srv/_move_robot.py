...
class MoveRobot_Event(metaclass=Metaclass_MoveRobot_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<interfaces/MoveRobot_Request, 1>',
        'response': 'sequence<interfaces/MoveRobot_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'srv'], 'MoveRobot_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['interfaces', 'srv'], 'MoveRobot_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from interfaces.srv import MoveRobot_Request
    ...
    def response(self, value):
        if self._check_fields:
            from interfaces.srv import MoveRobot_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_MoveRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _move_robot
...
class MoveRobot(metaclass=Metaclass_MoveRobot):
    from interfaces.srv._move_robot import MoveRobot_Request as Request
    from interfaces.srv._move_robot import MoveRobot_Response as Response
    from interfaces.srv._move_robot import MoveRobot_Event as Event
